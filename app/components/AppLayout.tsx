...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <header className="bg-gray-800 sticky top-0 z-50">
        <div className="flex justify-between items-center h-14 px-4">
          ...
          <div className="flex items-center">
            ...
            <Link href="/" className="ml-4 text-2xl font-bold text-red-500">
              slutspace
            </Link>
          </div>
      ...
      {/* Mobile menu */}
      <div className={`
        md:hidden fixed inset-0 z-40 bg-gray-900 transition-transform transform ease-in-out duration-300
        ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}
      `}>
        <div className="flex justify-between items-center h-14 px-4 bg-gray-800">
        ...
        <div className="overflow-y-auto h-full pb-20">
          ...
          <div className="px-2 py-4">
            ...
            <div className="mt-2 space-y-1">
              <Link href="/profile" className="flex items-center px-4 py-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg">
                <UserCircleIcon className="h-6 w-6 mr-3" />
                <span>Profile</span>
              </Link>
              <Link href="/settings" className="flex items-center px-4 py-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg">
                <CogIcon className="h-6 w-6 mr-3" />
                <span>Settings</span>
              </Link>
              <Link href="/login" className="flex items-center px-4 py-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg">
